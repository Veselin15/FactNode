...
export default function FactCard({ fact }: FactCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300 group">
      ...
      {/* Image Section */}
      {fact.image && (
        <div className="h-64 w-full relative overflow-hidden bg-gray-100 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
          ...
          />
          <div className="absolute top-4 left-4 bg-white/90 backdrop-blur px-3 py-1.5 rounded-full text-xs font-bold text-blue-700 shadow-sm">
